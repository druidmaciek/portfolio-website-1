...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-8484d704.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-8484d704.js", "/./_app/chunks/vendor-7132220e.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {entry: "/./_app/pages/__layout.svelte-735c4bba.js", css: [], js: ["/./_app/pages/__layout.svelte-735c4bba.js", "/./_app/chunks/vendor-7132220e.js"], styles: null}, ".svelte-kit/build/components/error.svelte": {entry: "/./_app/error.svelte-60983c74.js", css: [], js: ["/./_app/error.svelte-60983c74.js", "/./_app/chunks/vendor-7132220e.js"], styles: null}, "src/routes/index.svelte": {entry: "/./_app/pages/index.svelte-76f0066f.js", css: [], js: ["/./_app/pages/index.svelte-76f0066f.js", "/./_app/chunks/vendor-7132220e.js", "/./_app/chunks/Heading-1876f92e.js"], styles: null}, "src/routes/tips.svelte": {entry: "/./_app/pages/tips.svelte-52355db0.js", css: [], js: ["/./_app/pages/tips.svelte-52355db0.js", "/./_app/chunks/vendor-7132220e.js", "/./_app/chunks/Heading-1876f92e.js"], styles: null}};
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="${"relative bg-blue-500"}"><div class="${"text-white absolute top-0 left-0 z-20 px-12 mt-2"}"><a href="${"/"}" class="${"font-black text-white text-xl underline"}">AccountWeb</a></div>
	<div class="${"text-white absolute top-0 right-0 z-20 px-12 mt-2"}"><a class="${"mr-4 hover:text-gray-100 hover:underline"}" href="${"/tips"}">Growth Tips for Accountants</a>
		<a class="${"hover:text-gray-100 hover:underline"}" href="${"#contact"}">Contact Me</a></div>
	...
	<div class="${"absolute inset-0 z-10 flex justify-center items-center text-center px-48"}"><div><h1 class="${"mt-4 text-6xl text-white font-semibold tracking-tight filter drop-shadow-lg cursor-default"}">I help accountants get more customers
			</h1>
...
var Preview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"pt-6"}"><div class="${"flex justify-between items-center text-gray-900"}"><img class="${"h-44 w-64 rounded shadow-lg"}"${add_attribute("src", image, 0)}${add_attribute("alt", title, 0)}>

		<div class="${"px-12"}"><h3 class="${"text-xl "}">${escape2(title)}</h3>
			<p class="${"mt-0.5 text-sm"}">${escape2(description)}</p>
...
var List$2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"space-y-6 divide-y"}">${validate_component(Preview, "Blog").$$render($$result, {
...
var Heading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<h2 class="${"my-12 " + escape2(color) + " text-center text-3xl font-semibold"}">${slots.default ? slots.default({}) : ``}</h2>`;
});
...
<div class="${"py-12"}"><div class="${"max-w-xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8"}"><h2 class="${"sr-only"}">Services</h2>
        ...
        <dl class="${"mt-24 space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-16"}"><div><dt><img class="${"rounded shadow-lg "}" src="${"screenshots/1.png"}" alt="${"MicroAccounting website"}">
					<p class="${"mt-5 text-lg leading-6 font-medium text-gray-900 sm:text-center"}">MicroAccounting
					</p></dt>
			</div><div><dt><img class="${"rounded shadow-lg "}" src="${"screenshots/2.png"}" alt="${"Insight Accountants Website"}">
					<p class="${"mt-5 text-lg leading-6 font-medium text-gray-900 sm:text-center"}">Insight Accountants
					</p></dt></div></dl></div></div>`;
});
...
<footer class="${"bg-white"}"><div class="${"max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8"}"><nav class="${"-mx-5 -my-2 flex flex-wrap justify-center"}" aria-label="${"Footer"}"><div class="${"px-5 py-2"}"><a href="${"/tips"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Growth Tips
        ...
        <div class="${"px-5 py-2"}"><a href="${"/about"}" class="${"text-base text-gray-500 hover:text-gray-900"}">About Me
          </a></div>
  
        <div class="${"px-5 py-2"}"><a href="${"#contact"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Contact Me
          </a></div></nav>
      
      <p class="${"mt-8 text-center text-base text-gray-400"}">\xA9 2021 AccountWeb, Inc. All rights reserved.
      </p></div></footer>`;
});
...
${validate_component(Layout, "Layout").$$render($$result, {bg: "bg-gray-100"}, {}, {
    default: () => `${validate_component(List$2, "Featured").$$render($$result, {}, {}, {})}`
  })}
...
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"bg-blue-700 p-4 text-white"}"><div class="${"flex justify-between items-center"}"><a href="${"/"}" class="${"font-black text-xl underline"}">AccountWeb</a>
		<div class="${"flex justify-end"}"><a class="${"mr-4  hover:text-gray-100 hover:underline"}" href="${"/tips"}">Growth Tips for Accountants</a>
