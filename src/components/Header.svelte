<header class="relative bg-blue-500">
	<div class="text-white absolute top-0 left-0 z-20 px-12 mt-2">
		<a href="/" class="font-black text-white text-xl underline">AccountWeb</a>
	</div>
	...
	<img
		...
		alt=""
	/>
	<div class="absolute inset-0 z-10 flex justify-center items-center text-center px-48">
		<div>
			<h1
				class="mt-4 text-6xl text-white font-semibold tracking-tight filter drop-shadow-lg cursor-default"
			>
				I help accountants get more customers
			</h1>

			<div class="mt-4 flex justify-center">
				<a href="#contact" class="py-2 px-8 text-white rounded border-2 border-white hover:bg-white hover:text-gray-900">Contact Me</a>
			</div>
		</div>
	</div>
</header>
